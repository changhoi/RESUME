...
- I participated in the Junction X Seoul hackathon. I designed a web game using AWS and took on the backend development part. I used AWS Fargate and Redis Pub/Sub for scalable real-time 1:N chatting game through websocket.
...
- Launched a business, project management SaaS using a mandalart chart.
...
- Built a social application that helps users practice the Ivy Lee Method, a rule for productivity improvement, in software engineering theory and artificial intelligence classes.
...
- Built dating application for everyone during HYU festival.
